 ...
 * skarabrae implementation : © <Your name here> <Your email address here>
 *
 ...
 * skarabrae.js
 *
 * skarabrae user interface script
 * 
...
function (dojo, declare, gamegui, counter) {
    return declare("bgagame.skarabrae", ebg.core.gamegui, {
        constructor: function(){
            console.log('skarabrae constructor');
