...
// #fake name
    ...
    "Op_n_boar" => [ 
        ...
        "name" => clienttranslate("Pay Boar"),
            ...
            // #names of the stats
            "game_vp_setl_count" => [
                "name" => clienttranslate("VP for settlers card (Furnish)"),
            ],
            "game_vp_setl_sets" => [
            ...
            "action_main_1" => [
                ...
                "tooltip" => clienttranslate(
                    "Spend Wool and Hides to move the Furnish Marker 1 space to the right on the Furnish Track. Cost: 1, 2, or 3 portions (each portion = 2 Wool or 1 Hide). Once flipped: Produces either 1 Barley or 1 Skaill Knife."
                ),
            ],
            "action_main_2" => [
                "create" => 4,
                ...
                "tooltip" => clienttranslate(
                    "Cook (spend) specific Resources to gain Food, Bones, Hides, and Wool. Hearth limit: Starts at 4 (can be increased). Once flipped: Hearth limit increases by 2."
                ),
            ],
            "action_main_3" => [
                "create" => 4,
                ...
                "tooltip" => clienttranslate(
                    "Spend 2 Resources shown on the tan banner of any 1 Action Tile to turn it over. Once flipped: Players may take a Cook Action at the end of each Round."
                ),
                "n" => "?cook",
            ],
            "action_main_4" => [
                ...
                "tooltip" => clienttranslate(
                    "Spend 2 or more different Resources (Hides, Barley, Seaweed, Wood) to clear Midden and gain Roof Cards. Once flipped: Clean becomes more effective, and Food can be spent as 1 of the Resource types."
                ),
            ],
            "action_main_5" => [
                "create" => 4,
                ...
                "tooltip" => clienttranslate(
                    "Spend a certain amount of a single Resource type (2-6) to advance the Trade Marker 1 space to the right on the Trade Track. After advancing, players can purchase other Resources for 1 Skaill Knife. Once flipped: Players can make purchases using any 1 Resource instead of a Skaill Knife."
                ),
            ],
            "action_main_6" => [
                "create" => 4,
                ...
                "craft" => "n_bone,n_wood",
                "tooltip" => clienttranslate(
                    "Gain Resources by placing Workers on Gather Action Tiles. Shore area provides either 1 Shell or Seaweed. Once flipped: Shore provides 1 Shell and 1 Seaweed or 1 Fish."
                ),
            ],
            "action_main_7" => [
                "create" => 4,
                ...
                "tooltip" => clienttranslate(
                    "Gain Resources by placing Workers on Gather Action Tiles. Hills area provides Wool or Stone resources. Once flipped: Options improve and gives 1 more Environment icon when harvesting."
                ),
            ],
            "action_main_8" => [
                "create" => 4,
                ...
                "craft" => "n_bone,n_wool",
                "tooltip" => clienttranslate(
                    "Gain Resources by placing Workers on Gather Action Tiles. Thickets area provides Wood resources. Once flipped: Options improve and gives 1 more Environment icon when harvesting."
                ),
            ],
            "action_main_9" => [
                "create" => 4,
                ...
                "tooltip" => clienttranslate(
                    "Gain Resources by placing Workers on Gather Action Tiles. Fields area provides Barley resources. Once flipped: Options improve and gives 1 more Environment icon when harvesting."
                ),
            ],
            "action_special_8" => [
                "create" => 1,
            ...
            "card_setl_1_9" => [
                ...
                "r" => "n_seaweed:2wood",
                "t" => 1,
                "tooltip" => clienttranslate("Pay 1 seaweed to gain 2 wood"),
            ],
            "card_setl_1_10" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_seaweed:2barley",
                "t" => 1,
                "tooltip" => clienttranslate("Pay 1 seaweed to gain 2 barley"),
            ],
            "card_setl_1_11" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_seaweed:2stone",
                "t" => 1,
                "tooltip" => clienttranslate("Pay 1 seaweed to gain 2 stone"),
            ],
            "card_setl_1_12" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_seaweed:2wool",
                "t" => 1,
                "tooltip" => clienttranslate("Pay 1 seaweed to gain 2 wool"),
            ],
            "card_setl_1_13" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "cotag(2,stone)",
                "t" => 1,
                "tooltip" => clienttranslate("Gain stone for each Hills stone"),
            ],
            "card_setl_1_14" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "cotag(3,wood)",
                "t" => 1,
                "tooltip" => clienttranslate("Gain wood for each Thickets stone"),
            ],
            "card_setl_1_15" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "cotag(4,barley)",
                "t" => 1,
                "tooltip" => clienttranslate("Gain barley for each Fields stone"),
            ],
            "card_setl_2_16" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "rabbit",
                "t" => 2,
                "tooltip" => clienttranslate("Hunt rabbit"),
            ],
            "card_setl_2_17" => [
                "create" => 4,
                "type" => "card setl",
            ...
            "card_setl_2_18" => [
                ...
                "r" => "2n_stone:sheep",
                "t" => 2,
                "tooltip" => clienttranslate("Pay 2 stone to gain sheep"),
            ],
            "card_setl_2_19" => [
                "create" => 4,
                "type" => "card setl",
            ...
            "card_setl_2_24" => [
                ...
                "r" => "n_stone:2shell",
                "t" => 2,
                "tooltip" => clienttranslate("Pay 1 stone to gain 2 shell"),
            ],
            "card_setl_2_25" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_stone:2barley",
                "t" => 2,
                "tooltip" => clienttranslate("Pay 1 stone to gain 2 barley"),
            ],
            "card_setl_2_26" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_stone:2wood",
                "t" => 2,
                "tooltip" => clienttranslate("Pay 1 stone to gain 2 wood"),
            ],
            "card_setl_2_27" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_stone:2seaweed",
                "t" => 2,
                "tooltip" => clienttranslate("Pay 1 stone to gain 2 seaweed"),
            ],
            "card_setl_2_28" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "cotag(1,seaweed)",
                "t" => 2,
                "tooltip" => clienttranslate("Gain seaweed for each Shore stone"),
            ],
            "card_setl_2_29" => [
                "create" => 4,
                "type" => "card setl",
            ...
            "card_setl_3_33" => [
                ...
                "r" => "2n_wood:deer",
                "t" => 3,
                "tooltip" => clienttranslate("Pay 2 wood to hunt deer"),
            ],
            "card_setl_3_34" => [
                "create" => 4,
                "type" => "card setl",
            ...
            "card_setl_3_39" => [
                ...
                "r" => "n_wood:2seaweed",
                "t" => 3,
                "tooltip" => clienttranslate("Pay 1 wood to gain 2 seaweed"),
            ],
            "card_setl_3_40" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_wood:2wool",
                "t" => 3,
                "tooltip" => clienttranslate("Pay 1 wood to gain 2 wool"),
            ],
            "card_setl_3_41" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_wood:2stone",
                "t" => 3,
                "tooltip" => clienttranslate("Pay 1 wood to gain 2 stone"),
            ],
            "card_setl_3_42" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_wood:2barley",
                "t" => 3,
                "tooltip" => clienttranslate("Pay 1 wood to gain 2 barley"),
            ],
            "card_setl_3_43" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "cotag(1,shell)",
                "t" => 3,
                "tooltip" => clienttranslate("Gain shell for each Shore stone"),
            ],
            "card_setl_3_44" => [
                "create" => 4,
                "type" => "card setl",
            ...
            "card_setl_4_48" => [
                ...
                "r" => "3n_barley:cow",
                "t" => 4,
                "tooltip" => clienttranslate("Pay 3 barley to gain cow"),
            ],
            "card_setl_4_49" => [
                "create" => 4,
                "type" => "card setl",
            ...
            "card_setl_4_54" => [
                ...
                "r" => "n_barley:2stone",
                "t" => 4,
                "tooltip" => clienttranslate("Pay 1 barley to gain 2 stone"),
            ],
            "card_setl_4_55" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_barley:2wool",
                "t" => 4,
                "tooltip" => clienttranslate("Pay 1 barley to gain 2 wool"),
            ],
            "card_setl_4_56" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_barley:2wood",
                "t" => 4,
                "tooltip" => clienttranslate("Pay 1 barley to gain 2 wood"),
            ],
            "card_setl_4_57" => [
                "create" => 4,
                "type" => "card setl",
                ...
                "r" => "n_barley:2shell",
                "t" => 4,
                "tooltip" => clienttranslate("Pay 1 barley to gain 2 shell"),
            ],
            "card_setl_4_58" => [
                "create" => 4,
                "type" => "card setl",
            ...
            "card_setl_4_59" => [
                ...
                "r" => "cotag(2,wool)",
                "t" => 4,
                "tooltip" => clienttranslate("Gain wool for each Hills stone"),
            ],
            "card_setl_4_60" => [
                "create" => 4,
                "type" => "card setl",
