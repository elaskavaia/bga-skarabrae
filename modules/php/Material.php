...
// #cooking Options (recipies)
    "recipe_1" => [ 
        ...
        "r" => "n_shell:food",
        "tooltip" => clienttranslate("Cook 1 Shell to gain 1 Food."),
],
    "recipe_2" => [ 
        "create" => 0,
        "type" => "recipe",
        ...
        "r" => "n_barley:food",
        "tooltip" => clienttranslate("Cook 1 Barley to gain 1 Food."),
],
    "recipe_3" => [ 
        "create" => 0,
        "type" => "recipe",
        ...
        "r" => "n_fish:food,bone",
        "tooltip" => clienttranslate("Cook 1 Fish to gain 1 Food and 1 Bone."),
],
    "recipe_4" => [ 
        "create" => 0,
        "type" => "recipe",
        ...
        "tooltip" => clienttranslate("Cook 1 Rabbit to gain 1 Food and 1 Hide."),
],
    "recipe_5" => [ 
        "create" => 0,
        "type" => "recipe",
        ...
        "tooltip" => clienttranslate("Cook 1 Sheep to gain 1 Food, 1 Hide, 1 Wool, and 1 Bone."),
],
    "recipe_6" => [ 
        "create" => 0,
        "type" => "recipe",
        ...
        "tooltip" => clienttranslate("Cook 1 Deer to gain 1 Food, 1 Hide, and 2 Bones."),
],
    "recipe_7" => [ 
        "create" => 0,
        "type" => "recipe",
        ...
        "tooltip" => clienttranslate("Cook 1 Cow to gain 2 Food, 1 Hide, and 2 Bones."),
],
    "recipe_8" => [ 
        "create" => 0,
        "type" => "recipe",
        ...
        "tooltip" => clienttranslate("Cook 1 Boar to gain 2 Food, 1 Bone, and 1 Hide (when flipped 2 Hide)."),
],
    "slot_trade_0" => [ 
        "create" => 0,
        "location" => "limbo",
